...
ISTRUZIONI_IT = [
    ...
    ("  scartata. Tipo e note si possono lasciare vuoti.", False),
    ...
    ("- L'asset tag identifica il dispositivo, ed e' l'unico dato che non", False),
    ("  puo' ripetersi: se e' gia' in inventario la riga non viene", False),
    ...
    ("  una sola stanza, oppure uno per uno.", False),
    ("", False),
...
ISTRUZIONI_EN = [
    ...
    ("  discarded. Type and notes can be left empty.", False),
    ...
    ("- The asset tag identifies the device, and is the only thing that", False),
    ("  cannot repeat: if it is already in the inventory the row is not", False),
